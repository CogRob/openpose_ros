...
// OpenPose
DEFINE_double(camera_fps,               30.0,           "Frame rate for webcam and saving video.");

DEFINE_string(model_folder,             "/home/antonella/software/openpose/models/",      "Folder path (absolute or relative) where the models (pose, face, ...) are located.");
...
DEFINE_int32(3d_min_views,              -1,             "Minimum number of view required to reconstruct each keypoint. By default (-1) it will require "
                                                        "all the cameras to see the keypoint in order to reconstruct it.");
